...
insert into baskets (products, identification)
values ('some products', 'dsad'),
       ('some product', 'asd'),
       ('example product', 'asds');

insert into orders (delivery, price, order_time, user_id, basket_id)
